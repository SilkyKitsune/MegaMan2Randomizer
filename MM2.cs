...
public static class MM2
{
        ...
        weaknessSets = new byte[BossCount][]
    {
        ...
        new byte[WeaponCount] { 0x01, 0x07, 0x02, 0x04, 0x04, 0x00, 0x00, 0x00 }  //Wily Alien W6
    },
    ...
    private static int[] ConvertAddressToSNES(Address address) => address switch
    {
        ...
        Address.BossBitFlags => Util.RepeatedSNESAddressMM2(0x00_4279),
        Address.ItemBitFlags => Util.RepeatedSNESAddressMM2(0x00_4281),

        Address.MegaBusterEnemyDamage =>     Util.RepeatedSNESAddressMM2(0x00_6998),
        Address.AtomicFireEnemyDamage =>     Util.RepeatedSNESAddressMM2(0x00_6A14),
        Address.AirShooterEnemyDamage =>     Util.RepeatedSNESAddressMM2(0x00_6A8C),
        Address.LeafShieldEnemyDamage =>     Util.RepeatedSNESAddressMM2(0x00_6B04),
        Address.BubbleLeadEnemyDamage =>     Util.RepeatedSNESAddressMM2(0x00_6B7C),
        Address.QuickBoomerangEnemyDamage => Util.RepeatedSNESAddressMM2(0x00_6BF4),
        Address.CrashBomberEnemyDamage =>    Util.RepeatedSNESAddressMM2(0x00_6C6C),
        Address.MetalBladeEnemyDamage =>     Util.RepeatedSNESAddressMM2(0x00_6CE4),
