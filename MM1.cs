...
public static class MM1
{
        ...
        weaknessSets = new byte[BossCount][]
    {
        ...
        new byte[WeaponCount] { 0x01, 0x05, 0x00, 0x02, 0x01, 0x01, 0x04, 0x00 }, //Elec Man (g seems wrong)
        ...
        new byte[WeaponCount] { 0x02, 0x02, 0x00, 0x07, 0x04, 0x04, 0x00, 0x00 }, //Copy Robot W2
        new byte[WeaponCount] { 0x02, 0x02, 0x00, 0x07, 0x02, 0x04, 0x14, 0x00 }, //CWU-01P W3
