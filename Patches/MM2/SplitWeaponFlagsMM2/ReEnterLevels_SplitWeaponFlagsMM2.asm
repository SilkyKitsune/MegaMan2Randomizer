...
LDA #$00             ; A9 00    ;              ;
STA $FD              ; 85 FD    ;              ;
STA RobotBitField    ; 85 9A    ; 0x03_62F3    ; I think is set at start/password screen
...
............................................................................................................................................
LDA $02              ; A5 02    ;              ;
STA RobotBitField    ; 85 9A    ; 0x03_648D    ; ???
AND #$03             ; 29 03    ;              ;
STA ItemBitField     ; 85 9B    ;              ;
LDA RobotBitField    ; A5 9A    ; 0x03_6493    ; ???
AND #$20             ; 29 20    ;              ;
LSR A                ; 4A       ;              ;
LSR A                ; 4A       ;              ;
LSR A                ; 4A       ;              ;
...
STA ItemBitField     ; 85 9B    ;              ;
............................................................................................................................................
LDA RobotBitField    ; A5 9A    ; 0x03_64C1    ; ???
STA $01              ; 85 01    ;              ;
LDA ItemBitField     ; A5 9B    ;              ;
STA $02              ; 85 02    ;              ;
LDX #$00             ; A2 00    ;              ;
...
LSR $02              ; 46 02    ;              ;
............................................................................................................................................
LDA RobotBitField    ; A5 9A    ; 0x03_7160    ; ???
STA $00              ; 85 00    ;              ;
EOR #$FF             ; 49 FF    ;              ;
STA $01              ; 85 01    ;              ;
CLC                  ; 18       ;              ;
............................................................................................................................................
LDA RobotBitField    ; A5 9A    ; 0x03_71BF    ; password screen after weapon get
ASL A                ; 0A       ;              ;
ORA #$01             ; 09 01    ;              ;
STA $00              ; 85 00    ;              ;
LDA ItemBitField     ; A5 9B    ;              ;
